...
# Guillain–Barré syndrome outbreak in Pune: a health emergency(2025)

The recent outbreak of Guillain–Barré syndrome in Pune (India) has become a matter of increasing national concern and has warranted the involvement of international agencies.[1](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)  As of March 8, 2025, the total number of Guillain–Barré syndrome cases in Pune was 225, with 197 confirmed diagnoses and 28 suspected cases, and can be considered as one of the largest Guillain–Barré syndrome outbreaks.[2,3](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)  The death toll has risen to 23 people in India, and Pune continues to be the worst affected with 11 deaths from Guillain–Barré syndrome.[4](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)  As cases continue to rise and spread in different states (eg, Assam, Karnataka, Andra Pradesh, and Tamil Nadu), this outbreak is taking a disturbing dimension.[3](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)

Guillain–Barré syndrome is a rare neurological disorder, in which a person's immune system attacks the peripheral nerves,[5](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)  and has been linked with preceding viral infections.[6](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)  The recent outbreak has been linked to microbes,  _Campylobacter jejuni_, and norovirus, and contaminated water is the primary source of infection. 25 stool samples from patients with Guillain–Barré syndrome tested positive for  _C jejuni_  and 11 tested positive for norovirus. Presence of coliform  _Escherichia coli_, norovirus, and  _C jejuni_  bacteria was found in 40 water samples in affected areas in and around Pune.[7](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)  Several agencies—including expert teams from federal and state departments—and WHO are working together to ensure that the outbreak is contained.

Currently, in light of new strains of virus and disease, some low-income and middle-income countries struggle with common infectious diseases caused by arboviruses and improper hygiene and sanitation, including safe water supply. The Guillain–Barré syndrome outbreak in Pune is one such instance where cases of  _C jejuni_  infection have rapidly increased due to poor water resources, causing havoc in the form of Guillain–Barré syndrome. Questions arise as to how to curtail and limit the spread of this disease. What is needed is to understand the key importance of maintaining robust infrastructure, particularly water sanitation systems. Countries with better infrastructure have fewer Guillain–Barré syndrome cases linked to  _Campylobacter_.[1](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)00414-3/fulltext#)  Public education on hygiene practices, continuous surveillance, and research play an important role in understanding the pathogenesis of Guillain–Barré syndrome. The triggering infection for the outbreak needs to be investigated in detail, as does the emphasis of the outbreak as waterborne. New laws should be enacted to enforce the supply of safe and clean water by responsible government bodies. By implementing these public health measures, future risk of disease outbreaks can be minimised.

We declare no competing interests.


# Disease and Patient Characteristics Contributing to Diagnostic Delays in Patients With Guillain-Barré Syndrome(2021)


## Abstract

**Introduction:**  Diagnosis of Guillain Barre syndrome (GBS) is often made clinically. Certain patient and disease characteristics can cause delays in diagnosis and management.

**Methods:**  Observational retrospective study of forty-four patients diagnosed with GBS either clinically, cerebrospinal fluid analysis, and/or by electro-diagnostic criteria at a teaching hospital (University of Missouri Hospital) in Columbia, Mid-Missouri between 2011 and 2017.

**Results:**  Patients with coexisting neurological conditions had statistically significant delay in diagnosis of GBS [Mean (SD); 13 ± 5 vs. 9.39 ± 4.7;  _p_  = 0.03]. Patients presenting with motor + symptoms (sensory and/or autonomic, in addition to motor), compared to those with only motor symptoms had statistically significant delay in diagnosis of GBS [Mean (SD); 11.90 ± 5 vs. 8.58 ± 4;  _p_  = 0.04].

**Discussion:**  Presence of co-existing neurological conditions, and motor + symptoms can delay timely diagnosis and management of GBS.


# Comparing the performance of the ABC, AIMS65, GBS, and pRS scores in predicting 90-day mortality or rebleeding among emergency department patients with acute upper gastrointestinal bleeding: A prospective multicenter study(2021)
...
Among the 1072 patients included during the study period, the overall 90-day mortality rate was 10.91% (117/1072) and the rebleeding rate was 12.03% (129/1072). In predicting 90-day mortality, the ABC and pRS scores performed better with an AUC of 0.722 (95% CI 0.675–0.768;  _P_<0.001) and 0.711 (95% CI 0.663–0.757;  _P_<0.001), respectively, compared to the AIMS-65 (AUC, 0.672; 95% CI, 0.624–0.721;  _P_<0.001) and GBS (AUC, 0.624; 95% CI, 0.569–0.679;  _P_<0.001) scores. In predicting rebleeding in 90 days, the AUC of all scores did not exceed 0.70.
...
# Guillain-Barré Syndrome Emerging From Syringomyelia Management: A Case Report(2026)
...
# Guillain–Barré syndrome(2025)
Guillain–Barré syndrome (GBS) is an immune-mediated peripheral nerve disease that usually occurs in response to a preceding infection. In 1916, Guillain, Barré and Strohl, members of the Société de Neurologie of the French Army, were the first to report on the additional findings in cerebrospinal fluid (CSF) in soldiers with a form of acute progressive weakness that was distinct from poliomyelitis. Since then, this condition has become a global concern, currently affecting an estimated 150,000 patients annually. The risk of developing GBS is higher with increasing age and in men.[1](https://www.bjaed.org/article/S2058-5349(25)00046-0/fulltext#) Patients typically present with weakness and sensory symptoms in the legs that can rapidly progress to the arms and cranial nerves.[2](https://www.bjaed.org/article/S2058-5349(25)00046-0/fulltext#) In 20–30% of patients, respiratory failure requiring mechanical ventilation (MV) occurs.[3](https://www.bjaed.org/article/S2058-5349(25)00046-0/fulltext#),[4](https://www.bjaed.org/article/S2058-5349(25)00046-0/fulltext#) Anaesthetists and intensivists are commonly asked to review and manage these patients in the initial progressive phase of disease. The discovery of new infective precipitants, alongside the description of clinical–pathological phenotypes, has clarified that there is a heterogeneous family of motor-sensory peripheral neuropathies with distinct cellular injuries. In this article, we discuss the inadequacies of conventional diagnostic investigations and the significance of their timing; current knowledge on the role of recent vaccines and surgery in causing GBS (which is currently unclear); and evidence-based management and new clinical tools to guide clinicians on the need for escalation of care for the deteriorating patient


# Guillain-Barré syndrome presenting with abdominal pain as the initial manifestation: a case report(2026)

## Abstract

**Background:**

Guillain-Barré syndrome (GBS) is an acute immune-mediated polyneuropathy, characteristically presenting with ascending limb weakness and sensory disturbances. However, GBS presenting with abdominal pain as the initial manifestation is relatively rare, abdominal pain is not a characteristic manifestation, its occurrence may delay diagnosis of GBS.

**Case presentation:**

A 62-year-old male patient presented to our hospital in January 2024 with a 5-day history of abdominal pain in the right upper quadrant. He was initially diagnosed with acute cholecystitis. However, the patient subsequently developed progressive limb weakness and loss of tendon reflexes, along with worsening respiratory distress and chest tightness, ultimately leading to a diagnosis of GBS. This case report describes a severe case of GBS presenting with acute abdominal pain as the initial manifestation, highlighting the diagnostic challenges of GBS in the setting of acute abdominal pain.

**Conclusion:**

Abdominal pain may precede characteristic neurological symptoms in GBS. GBS presenting with acute abdominal pain as the initial manifestation may pose diagnostic challenges and lead to delayed diagnosis. Physicians should maintain a high index of suspicion for GBS in patients with abdominal pain and rapid neurological deterioration.

# Acute Brucellosis with a Guillain-Barre Syndrome-Like Presentation: A Case Report and Literature Review(2020)
...
# Guillain-Barré syndrome as the first presentation of human immunodeficiency virus infection(2021)
...
("Guillain-Barre syndrome" OR GBS) AND (triage OR referral)

**Management of Guillain–Barré syndrome in Bangladesh: Clinical practice, limitations and recommendations for low- and middle-income countries**(2023)
...
**Tackling respiratory failure in Guillain Barre’ syndrome: Burdens, management and prognosis**(2025)
